...
public class Log extends JFrame {
	...
	public void InitWnd() {
		...
		setSize(400, 300);      //the size of client window
		...
		btnreg.setBounds(25, 105, 110, 35);//location of three buttons (log in, sign up and cancel)
		btnlog.setBounds(135, 105, 110, 35);//（x,y,w,h）
		btncnl.setBounds(245, 105, 110, 35);
